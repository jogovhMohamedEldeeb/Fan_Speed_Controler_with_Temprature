...
# 12 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h"
...
# 12 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h" 2
...
# 13 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h" 2
...
# 15 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h" 2
...
# 16 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h" 2
# 28 "Mcal_layer/ADC/../../Mcal_layer/GPIO/../../device_config.h"
...
# 27 "Mcal_layer/ADC/../../Mcal_layer/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW = 0,
   GPIO_HIGH
}logic_t;
...
Std_ReturnType ADC_intialize(const adc_config_t *_adc){
    ...
    if(((void*)0) != _adc){
        ...
        if(1 == _adc->format_justification){
            (ADCON2bits.ADFM = 1);
        }
        else{
            (ADCON2bits.ADFM = 0);
...
Std_ReturnType ADC_getConversionResult(const adc_config_t *_adc, converion_result_t *result){
    ...
    if((((void*)0) != _adc) && (((void*)0) != result)){
        ...
        else if(0 == _adc->format_justification){
...
static Std_ReturnType ADC_Configure_Channel_pin(const adc_analog_channel_t channel){
    ...
    switch(channel){
        case ANALOG_CHANNEL_AN0: (TRISA |= ((uint8) 1 << 0x0)); break;
        case ANALOG_CHANNEL_AN1: (TRISA |= ((uint8) 1 << 0x1)); break;
        case ANALOG_CHANNEL_AN2: (TRISA |= ((uint8) 1 << 0x2)); break;
        case ANALOG_CHANNEL_AN3: (TRISA |= ((uint8) 1 << 0x3)); break;
        case ANALOG_CHANNEL_AN4: (TRISA |= ((uint8) 1 << 0x5)); break;
        case ANALOG_CHANNEL_AN5: (TRISE |= ((uint8) 1 << 0x0)); break;
        case ANALOG_CHANNEL_AN6: (TRISE |= ((uint8) 1 << 0x1)); break;
        case ANALOG_CHANNEL_AN7: (TRISE |= ((uint8) 1 << 0x2)); break;
        case ANALOG_CHANNEL_AN8: (TRISB |= ((uint8) 1 << 0x2)); break;
        case ANALOG_CHANNEL_AN9: (TRISB |= ((uint8) 1 << 0x3)); break;
        case ANALOG_CHANNEL_AN10: (TRISB |= ((uint8) 1 << 0x1)); break;
        case ANALOG_CHANNEL_AN11: (TRISB |= ((uint8) 1 << 0x4)); break;
        case ANALOG_CHANNEL_AN12: (TRISB |= ((uint8) 1 << 0x0)); break;
