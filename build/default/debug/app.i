...
# 16 "./Mcal_layer/GPIO/../../device_config.h" 2
# 28 "./Mcal_layer/GPIO/../../device_config.h"
...
int main() {
    ...
    while(1){
        ...
        lm35_value_in_celsuis = roundf(lm35_value_in_celsuis / 10.0);
