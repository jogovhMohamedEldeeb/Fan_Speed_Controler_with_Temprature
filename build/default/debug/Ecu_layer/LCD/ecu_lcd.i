...
# 16 "Ecu_layer/LCD/../../Mcal_layer/GPIO/../../device_config.h" 2
# 28 "Ecu_layer/LCD/../../Mcal_layer/GPIO/../../device_config.h"
...
# 27 "Ecu_layer/LCD/../../Mcal_layer/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW = 0,
   GPIO_HIGH
}logic_t;
...
static Std_ReturnType lcd_8bit_set_cursor(const lcd_8bit_t *lcd, uint8 row, uint8 colomn){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) != lcd && row <= 2 && colomn <= 16){
        colomn--;
        switch(row){
            case 1: ret = lcd_8bit_send_command(lcd, (0x80 + colomn)); break;
            case 2: ret = lcd_8bit_send_command(lcd, (0xc0 + colomn)); break;
            default: break;
        }
    }
    return ret;
